...
def generate_launch_description():
    ...
    srdf_file = get_package_file('ur5_moveit', 'config/ur5.srdf')
    kinematics_file = get_package_file('ur5_moveit', 'config/kinematics.yaml')
    ompl_config_file = get_package_file('ur5_moveit', 'config/ompl_planning.yaml')
    moveit_controllers_file = get_package_file('ur5_moveit', 'config/controllers.yaml')
